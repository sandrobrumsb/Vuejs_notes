...
/* Posso declara variaveis aqui em ecript e usar no props: */
const VariavelCaderno = "Caderno declarado com variavel";
const VariavelBorracha = 2.5;
const cachorrosDoSandro = [
  { nome: "Cacau", idade: 4 },
  { nome: "Aurora", idade: 4 },
];
</script>
...
<template>
  ...
  <RenderizacaoListas nome="Sandro" :cachorros="cachorrosDoSandro" />
  <RenderizacaoCondicional nome="Sandro" :qtde-cachorros="2" />
  ...
  <CompProps item="Borracha" v-bind:preco="2.99" />
  <CompProps item="Borracha com o atalho v-bind " :preco="20.5" />
  <CompProps :item="VariavelCaderno" :preco="VariavelBorracha" />
